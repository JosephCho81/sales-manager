 ...
 */
import { calcMarginFromContract, splitMargin, fmtNum } from '@/lib/margin'
...
export type ProductChange = {
  ...
  qtyDelta: number
  qtyPct: number | null        // null if prevQtyTon = 0 (신규)
  marginDelta: number
  marginPct: number | null     // null if prevMargin = 0 (신규)
